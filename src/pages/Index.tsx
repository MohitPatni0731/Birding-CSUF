...
const Index = () => {
  ...
  const birdSpecies: BirdSpecies[] = [
    ...
    { name: "Great Horned Owl", scientificName: "Bubo virginianus", image: "/great horned owl.jpg", description: "Large owl with prominent ear tufts and piercing yellow eyes.", funFact: "Great Horned Owls have a grip strength of about 300 psi - stronger than most dogs!", habitat: "Diverse habitats from forests to deserts; occasionally spotted in the Arboretum." },
